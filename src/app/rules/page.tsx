...
export const metadata: Metadata = {
  title: "قوانین و مقررات | سوزن رویا",
  description:
    "در این صفحه شما به صورت کامل با قوانین و مقررات این فروشگاه اشنا میشوید",
  keywords: [
  ...
  alternates: {
    canonical: "https://dream-needle.ir/rules",
  },
  openGraph: {
    title: "شرایط و قوانین فروشگاه سوزن رویا",
    description: "در این صفحه شما به صورت کامل با قوانین و مقررات این فروشگاه اشنا میشوید",
    url: "https://dream-needle.ir/rules",
