...
export const metadata: Metadata = {
  title: "درباره ما | سوزن رویا",
  description: "در این صفحه شما به صورت کامل با فروشگاه سوزن رویا اشنا میشوید",
  keywords: [
  ...
  alternates: {
    canonical: "https://dream-needle.ir/about_us",
  },
  openGraph: {
    title: "درباره شرکت سوزن رویا",
    description:
      "در این صفحه شما به صورت کامل با فروشگاه سوزن رویا اشنا میشوید",
    url: "https://dream-needle.ir/about_us",
  ...
  return (
    <div className="flex relative flex-col justify-between items-center w-full min-h-[100dvh] bg-backgroundColorTheme_2 text-textColorTheme">
      ...
      <div className="w-full text-center my-10">
        ...
        <p className="md:text-base text-sm px-2">
          این قسمت توسط برنامه نویسان در حال توسعه میباشد لطفا صبور باشید
        </p>
      </div>
      <Footer_main />
    </div>
