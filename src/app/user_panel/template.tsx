...
import Headre_panel_user from "@/components/header/Headre_panel_user";
    ...
    <div>
      <Is_login>
        ...
        <div className="flex relative flex-row justify-center items-start w-full min-h-[100dvh] bg-backgroundColorTheme_2 text-textColorTheme">
          <div className="flex fixed top-0 right-0 flex-col justify-start items-start min-h-[100dvh] lg:w-[290px] md:w-[240px]  max-md:hidden">
            <Sidbar_panel_user />
          </div>
          <div className="flex flex-col justify-start items-start w-full min-h-[100dvh] lg:pr-[290px] md:pr-[240px] pr-0">
            <Headre_panel_user />
