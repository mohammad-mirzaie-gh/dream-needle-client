...
export const metadata: Metadata = {
  title: "پیشنهادات و اعتراضات | سوزن رویا",
  description:
    "در این صفحه شما  میتوانید هرگونه پیشنهاد , نظر یا شکایاتی از رویه کارکرد این فروشگاه داشته باشید را با ما در میان بگزارید",
  keywords: [
  ...
  alternates: {
    canonical: "https://dream-needle.ir/suggestions_and_objections",
  },
  openGraph: {
    title: "پیشنهادات و شکایات فروشگاه سوزن رویا",
    description: "در این صفحه شما میتوانید هرگونه پیشنهاد , نظر یا شکایاتی از رویه کارکرد این فروشگاه داشته باشید را با ما در میان بگزارید",
    url: "https://dream-needle.ir/suggestions_and_objections",
